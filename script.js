...
// Manage Page Btns
		...
		$scope.prev = function(){
			...
			//$scope.myTxt += " cur_page: " + $scope.cur_page;

			prevSearch_url = "helloworld-198821.appspot.com/?";
			if($scope.cur_page == 0){ //re nearbySearch
...
//$scope.myTxt += " url:" + prevSearch_url;
//$scope.myTxt += " next_page_token:" + $scope.next_page;
...
//$scope.myTxt += "keyword: " + $scope.keyword + " type: " + $scope.type + " radius: " + $scope.real_radius + " from: " + $scope.from + " other_loc: " + $scope.other_loc; 
//$scope.myTxt += " location: " + $scope.location + " func: " + $scope.func;
...
//$scope.myTxt = " next_page: " + $scope.next_page;
        ...
        $scope.detail = function(name, address, plcae_id, func){
			...
			.then(function successCallback(response) {
				...
				if($scope.detail_data.opening_hours){
					...
					// $scope.myTxt += "      local time: " + uctToLocal +" day:"+ moment(tmp_d).format('d');
					...
					//$scope.myTxt += ", day of week: " + $scope.detail_cur_dayOfWeek;
...
//$scope.myTxt = "country:" + $scope.detail_country + ", state:" + $scope.detail_state + ", city:" + $scope.detail_city + ", postal_code:" 
//$scope.myTxt += $scope.detail_postal_code + ",address1:" + $scope.detail_address1;
//$scope.myTxt += ",phone_num:" + $scope.detail_yelp_phoneNum;
...
// $scope.myTxt = "$scope.favorite_data.length:" + $scope.favorite_data.length;
// $scope.myTxt += "$scope.cur_favorite_data.length:" + $scope.cur_favorite_data.length;
		...
		$scope.prev_fav = function() {
			...
			// $scope.myTxt += "$scope.favorite_album length:"+ $scope.favorite_album.length;
...
// (4) Manage Review information. 
		...
		$scope.getYelpReview = function(){
			...
			//$scope.myTxt += "yelp url:" + yelpSearch_url;
